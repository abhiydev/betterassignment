        ...
        <div className="m-auto px-6 py-6 md:px-10 lg:px-16 xl:px-20 2xl:px-40">
            ...
            <div className="mt-6 flex flex-col gap-y-8 md:flex-row md:gap-16">
                    ...
                    <ul className="mt-6 space-y-4">
                        <li className="mt-4">
                            ...
                            <p className="font-normal leading-body m-0 p-0 text-left text-textPrimary text-sm mt-3">
                                We cant wait to say “Welcome home.” Apply 100% online, with expert customer support.
                            </p>
                        </li>
                        <li>
                            <a href="/b/realestate/">
                        ...
                        <li>
                            <a href="/title/">
                                <Image
                                    ...
                                    alt="Better Settlement Services Logo"
                                    width={240}
                                    height={21}
                                    loading="lazy"
                                />
                ...
                <div className="flex-shrink flex-grow basis-0">
                    ...
                    <ul className="mt-2 space-y-4 md:mt-6">
                        ...
                        <li>
                            <a href="/mortgage-calculator/" className="hover-gradient-effect block py-1 text-link">
                                Mortgage calculator
                            </a>
                        </li>
                        <li>
                            <a href="/free-mortgage-calculator/" className="hover-gradient-effect block py-1 text-link">
                                Free mortgage calculator
                            </a>
                        </li>
                        <li>
                            <a href="/mortgage-calculator-with-taxes/" className="hover-gradient-effect block py-1 text-link">
                                Mortgage calculator with taxes
                            </a>
                        </li>
                        <li>
                            <a href="/mortgage-calculator-with-pmi/" className="hover-gradient-effect block py-1 text-link">
                                Mortgage calculator with PMI
                            </a>
                        </li>
                        <li>
                            <a href="/rent-vs-buy-calculator/" className="hover-gradient-effect block py-1 text-link">
                                Rent vs buy calculator
                            </a>
                        </li>
                        <li>
                            <a href="/heloc-calculator" className="hover-gradient-effect block py-1 text-link">
                                HELOC payment calculator
                            </a>
                        </li>
                        <li>
                            <a href="/heloc-vs-cashout-refi-calculator/" className="hover-gradient-effect block py-1 text-link">
                                HELOC vs cash-out refinance calculator
                            </a>
                        </li>
                        <li>
                            <a href="/content/buying-a-house-online/" className="hover-gradient-effect block py-1 text-link">
                                Buy a home
                            </a>
                        </li>
                        <li>
                            <a href="/content/buying-and-selling-a-home-at-the-same-time/" className="hover-gradient-effect block py-1 text-link">
                                Sell a home
                            </a>
                        </li>
                        <li>
                            <a href="/content/home-inspection-checklist/" className="hover-gradient-effect block py-1 text-link">
                                Get home inspection
                            </a>
                        </li>
                    </ul>
                ...
                <div className="flex-shrink flex-grow basis-0">
                    ...
                    <ul className="mt-2 space-y-4 md:mt-6">
                        <li>
                            <a href="/about-us/" className="hover-gradient-effect block py-1 text-link">
                                About Us
                            </a>
                        </li>
                        <li>
                            <a href="/about-us/careers/" className="hover-gradient-effect block py-1 text-link">
                                Careers
                            </a>
                        </li>
                        <li>
                            <a href="/about-us/media/" className="hover-gradient-effect block py-1 text-link">
                                Media
                            </a>
                        </li>
                        <li>
                            <a href="/partnerships/" className="hover-gradient-effect block py-1 text-link">
                                Partner With Us
                            </a>
                        </li>
                        <li>
                            <a href="/content/" className="hover-gradient-effect block py-1 text-link">
                                Learning center
                            </a>
                        </li>
                        <li>
                            <a href="/faq/" className="hover-gradient-effect block py-1 text-link">
                                FAQs
                            </a>
                        </li>
                        <li>
                            <a href="https://investors.better.com" className="hover-gradient-effect block py-1 text-link">
                                Investor Relations
                            </a>
                        </li>
                    </ul>
                ...
                <div className="flex-shrink flex-grow basis-0">
                    ...
                    <ul className="mt-2 space-y-4 md:mt-6">
                        <li>
                            <a href="mailto:hello@better.com" className="text-link">
                                hello@better.com
                            </a>
                        </li>
                        <li>
                            <a href="tel:415-523-8837" className="text-link">
                                415-523-8837
                            </a>
                        </li>
                        <li>
                        ...
                        <li>
                            <a href="/glossary" className="hover-gradient-effect block py-1 text-link">
                                Glossary
                            </a>
                        </li>
                    </ul>
            ...
            <div className="mt-12">
                ...
                <p className="font-normal leading-body m-0 p-0 text-left text-textPrimary text-xs mt-4">
                    Home lending products offered by Better Mortgage Corporation. Better Mortgage Corporation is a direct lender. NMLS #330511. 1 World Trade Center, 80th Floor, New York, NY 10007. Loans made or arranged pursuant to a California Finance Lenders Law License. Not available in all states. Equal Housing Lender. <a className="underline" data-qa="nmls-link" href="http://www.nmlsconsumeraccess.org/EntityDetails.aspx/COMPANY/330511">NMLS Consumer Access</a>
                </p>
                <p className="font-normal leading-body m-0 p-0 text-left text-textPrimary text-xs mt-4">
